...
function FAQs (){
    ...
    return(
        ...
        <div className={styles.faqsnav}>
            ...
            {ranchFaqs.map((faq) => <FaqItem faq={faq} key={faq.id}/>)}
            </ul>
            <svg className={styles.waves} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="rgb(69, 75, 27)" fill-opacity="1" d="M0,0L21.8,42.7C43.6,85,87,171,131,218.7C174.5,267,218,277,262,245.3C305.5,213,349,139,393,138.7C436.4,139,480,213,524,234.7C567.3,256,611,224,655,181.3C698.2,139,742,85,785,96C829.1,107,873,181,916,197.3C960,213,1004,171,1047,176C1090.9,181,1135,235,1178,266.7C1221.8,299,1265,309,1309,282.7C1352.7,256,1396,192,1418,160L1440,128L1440,0L1418.2,0C1396.4,0,1353,0,1309,0C1265.5,0,1222,0,1178,0C1134.5,0,1091,0,1047,0C1003.6,0,960,0,916,0C872.7,0,829,0,785,0C741.8,0,698,0,655,0C610.9,0,567,0,524,0C480,0,436,0,393,0C349.1,0,305,0,262,0C218.2,0,175,0,131,0C87.3,0,44,0,22,0L0,0Z"></path></svg>
